...
const styles = StyleSheet.create({
  ...
  quality: { color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center' },
  caption: { color: '#D1D1D6', fontSize: 14, textAlign: 'center' },
