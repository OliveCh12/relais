...
- Current smoke checks: Home → Camera → Settings → return; Home → Monitor → add/connect → device Settings. Recording stays independent of the preview link. Follow the dedicated recording and pairing protocols below.
